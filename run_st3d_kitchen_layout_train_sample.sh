...
mpiexec -n $NUM_GPUS python scripts/st3d_room_layout_train.py \
 ...
 --log_dir log/ST3D_kitchen/2024021_normalized \
...
python scripts/st3d_room_layout_sample.py \
 --data_dir /mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/20240215_text2pano/test/kitchen/ \
 --model_path log/ST3D_kitchen/2024021_normalized/ema_0.9999_400000.pt \
 $MODEL_FLAGS \
 $DIFFUSION_FLAGS \
 --room_type $ROOM_TYPE \
