...
NUM_GPUS=2
MAX_STEPS=400000
train_stats_file="/mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/20240215_text2pano/train/livingroom/train_dataset_stats.json"
mpiexec -n $NUM_GPUS python scripts/st3d_room_layout_train.py \
 --data_dir /mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/20240215_text2pano/train/livingroom/ \
 $MODEL_FLAGS \
 $DIFFUSION_FLAGS \
 $TRAIN_FLAGS \
 --lr_anneal_steps $MAX_STEPS \
 --log_dir log/ST3D_livingroom/20240217_normalized \
...
python scripts/st3d_room_layout_sample.py \
 --data_dir /mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/20240215_text2pano/test/livingroom/ \
 --model_path log/ST3D_livingroom/20240217_normalized/ema_0.9999_400000.pt \
 $MODEL_FLAGS \
 $DIFFUSION_FLAGS \
 --room_type $ROOM_TYPE \
