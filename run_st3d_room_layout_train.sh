...
mpiexec -n $NUM_GPUS python scripts/st3d_room_layout_train.py --data_dir /mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/debug_livingroom/train/livingroom/ $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
