...
TRAIN_FLAGS="--lr 1e-4 --batch_size 32 --schedule_sampler loss-second-moment  --resume_checkpoint /codes/HolisticDiffuScene/log/openai-2023-06-28-12-29-42-231944/model130000.pt"
NUM_GPUS=2
...
mpiexec -n $NUM_GPUS python scripts/st3d_room_layout_train.py --data_dir /mnt/nas_3dv/hdd1/datasets/Structured3d/preprocessed/all_raw_light/bedroom $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
